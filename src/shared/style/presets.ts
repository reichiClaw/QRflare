...
export const BUILT_IN_PRESETS: Preset[] = [
  preset({
    ...
    style: {
      ...
      gradient: { enabled: false, type: 'linear', angle: 45, stops: [{ offset: 0, color: '#000000' }, { offset: 1, color: '#000000' }], target: 'all' },
  ...
  preset({
    ...
    style: {
      ...
      foreground: '#1D4ED8',
      background: '#FFFFFF',
      gradient: { enabled: false, type: 'linear', angle: 45, stops: [{ offset: 0, color: '#1D4ED8' }, { offset: 1, color: '#1D4ED8' }], target: 'all' },
  ...
  preset({
    ...
    style: {
      ...
      foreground: '#1F2937',
      background: '#F9FAFB',
      gradient: { enabled: false, type: 'linear', angle: 45, stops: [{ offset: 0, color: '#1F2937' }, { offset: 1, color: '#1F2937' }], target: 'all' },
  ...
  preset({
    ...
    style: {
      ...
      layout: {
        ...
        caption: { enabled: false, text: 'Scan me', fontSize: 64, fontWeight: 700, align: 'center', letterSpacing: 0, color: '#000000', position: 'bottom', gap: 24 },
      },
    },
  }),
  preset({
    ...
    style: {
      ...
      foreground: '#111827',
      background: '#FFFFFF',
      gradient: { enabled: false, type: 'linear', angle: 45, stops: [{ offset: 0, color: '#111827' }, { offset: 1, color: '#111827' }], target: 'all' },
  ...
  preset({
    ...
    style: {
      ...
      foreground: '#0F172A',
      background: '#FFFFFF',
      gradient: { enabled: false, type: 'linear', angle: 45, stops: [{ offset: 0, color: '#0F172A' }, { offset: 1, color: '#0F172A' }], target: 'all' },
  ...
  preset({
    ...
    style: {
      ...
      layout: {
        ...
        caption: { enabled: true, text: 'Scan me', fontSize: 72, fontWeight: 700, align: 'center', letterSpacing: 2, color: '#000000', position: 'bottom', gap: 24 },
      },
    },
  }),
];
